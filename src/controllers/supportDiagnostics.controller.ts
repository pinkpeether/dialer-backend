...
export const getDiagnostics = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const diagnostics = await SupportDiagnosticsService.getSupportDiagnostics(req.user)
...
export const downloadDiagnostics = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const diagnostics = await SupportDiagnosticsService.getSupportDiagnostics(req.user)
